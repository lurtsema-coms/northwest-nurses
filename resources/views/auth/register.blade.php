    ...
    <body class="font-sans text-gray-900 antialiased flex m-auto min-h-screen">
        <div class="w-full max-w-7xl flex flex-row justify-center m-auto bg-white shadow-md overflow-hidden h-[35rem]">
            <div class=" max-w-[520px] flex flex-col bg-primary bg-contain bg-no-repeat bg-center p-3">
                ...
                <div class="p-3 ">
                    <img src="{{ asset('img/applicant.png') }}" alt="" class=" w-80 object-contain mx-auto">
                    <img src="{{ asset('img/employer.png') }}" alt="" class=" w-80 object-contain mx-auto hidden">
                </div>
                <div class="p-3 flex justify-center text-center gap-5 ">
                    <x-primary-button id="applicantButton" class="bg-white text-black rounded-bl-none rounded-tr-none focus:outline-none focus:ring-2 focus:ring-white">Applicant</x-primary-button>
                    <x-primary-button id="employerButton" class="bg-white text-black rounded-bl-none rounded-tr-none">Employer</x-primary-button>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $("#applicantButton").click(function() {
                $(this).toggleClass("bg-red-500 cursor-not-allowed");
