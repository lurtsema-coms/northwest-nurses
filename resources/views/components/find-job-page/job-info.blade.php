    ...
    <div class="p-5">
        <div class="my-5">
            ...
            <div class="flex flex-col sm:flex-row justify-between mt-5 gap-5">
                ...
                @auth
                @role('applicant')
                <button id="apply-now-btn" class="bg-primary hover:opacity-75 text-white px-5 py-2 rounded-full" data-entry-id="{{ $jobPost->id }}" data-href="{{ route('get-job', $jobPost->id ) }}">Apply Now</button>
                @endrole
                @role('employer')
