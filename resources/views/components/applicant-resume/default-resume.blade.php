@foreach ($my_resumes as $my_resume)
    <div class="relative flex items-center justify-center w-full mt-5 overflow-hidden sm:w-2/3">
        <label  class="flex items-center w-full h-[8rem] border-2 border-gray-300 rounded-lg bg-gray-50 py-5 px-5 lg:px-16	">
            ...
            <div class="relative p-1 cursor-pointer rounded-3xl hover:bg-gray-200 dropdown">
                ...
                <div class="bg-white absolute right-[44px] top-[-44px] z-10 hidden dropdown-menu rounded-xl shadow-md p-3">
                    @if ($my_resume->default == 0)
                    <div class="flex items-center w-full px-3 py-1 mb-1 text-sm font-semibold text-gray-800 cursor-pointer hover:bg-gray-100 default-btn"
                    hx-trigger="click" hx-get="{{ route('applicant.default.resume', $my_resume->id) }}" hx-target="#resume-container" hx-swap="innerHTML">
                    ...
                    @endif
                    <div class="flex items-center w-full px-3 py-1 mb-1 text-sm font-semibold text-gray-800 cursor-pointer hover:bg-gray-100 download-btn " data-file-path="{{ $my_resume->file_path }}" >
                    ...
                    <div class="flex items-center w-full px-3 py-1 text-sm font-semibold text-red-500 cursor-pointer hover:bg-gray-100 delete-btn" data-entry-id="{{ $my_resume->id }}" data-href="{{ route('applicant.profile.delete-resume', $my_resume->id ) }}">
