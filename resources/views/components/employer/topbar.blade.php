    ...
    <div class="flex">
        ...
        <div class="bg-white rounded-md px-3 py-2 shadow-sm mr-3 relative hover:cursor-pointer hover:shadow-md" id="profile-button">
            ...
            <div class="hidden" id="profile-setting">
                <div class="flex flex-col absolute w-48 top-12 right-0 bg-white text-slate-500 shadow-md transition-all">
                    <a class="flex px-5 py-2 hover:bg-slate-300 space-x-2"
                        hx-get="{{ route('employer.profile') }}" hx-target="#target-content" hx-push-url="true" hx-on:click="removeBgColor(event    )"
                    >
