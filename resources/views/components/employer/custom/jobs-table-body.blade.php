            ...
            <tr >
                ...
                <td class="px-6 py-4 text-sm whitespace-nowrap">
                    <div class="flex gap-2">
                        ...
                        <button class="bg-yellow-500 text-gray-50 px-3 py-1 rounded-md shadow-md hover:bg-yellow-400"
                            ...
                            Applicants
                            <svg class="animate-spin h-5 w-5 text-white htmx-indicator" id="{{ 'spinner'.'-'.$job->id }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
