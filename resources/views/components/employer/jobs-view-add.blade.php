            ...
            <div class="w-full">
                ...
                <div class="relative flex items-center justify-center w-full overflow-hidden">
                    <label for="dropzone-file" id="dropzone-parent" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 draggable="true">
                        <input id="dropzone-file" type="file" class="absolute -z-10 w-7" name="img_link" accept="image/*" required>
            ...
            <div class="mt-10 space-y-5 text-slate-500">
                ...
                <div class="flex flex-wrap gap-5">
                    <div class="flex flex-col flex-1 space-y-2">
                        ...
                        <textarea class="px-2 border border-gray-300 rounded-md focus:border-1 focus:border-cyan-600 focus:ring-0 focus:outline-none" name="benefits" id="" rows="7" placeholder="Insert job benefits..." required></textarea>
                        @error('benefits')
                            <div class="text-red-600">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="flex flex-wrap gap-5">
                    <div class="flex flex-col flex-1 space-y-2">
                        ...
                        <div class="flex items-center w-full h-24 max-w-lg gap-4 p-10 rounded-lg bg-slate-300">
