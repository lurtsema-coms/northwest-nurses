    ...
    <div class="flex flex-wrap gap-3">
        <div class="flex justify-between items-center bg-white px-10 py-5 shadow-sm rounded-2xl" style="flex: 1 0 250px;">
            <div class="mr-3">
                ...
                <p class="text-xl">{{ $job_total_posts }}</p>
            </div>
        ...
        <div class="flex justify-between items-center bg-white px-10 py-5 shadow-sm rounded-2xl" style="flex: 1 0 250px;">
            <div class="mr-3">
                ...
                <p class="text-xl">{{ $job_active_posts }}</p>
            </div>
            <div class="bg-white rounded-md px-3 py-2 shadow-md mr-3">
    ...
    <div class="flex flex-wrap gap-3">
        <div class="flex justify-between items-center bg-white px-10 py-5 shadow-sm rounded-2xl" style="flex: 1 0 250px;">
            <div class="mr-3">
                ...
                <p class="text-xl">{{ $job_expired_posts }}</p>
            </div>
            <div class="bg-white rounded-md px-3 py-2 shadow-md mr-3">
...
<div class="bg-white p-10 rounded-3xl shadow-sm overflow-x-auto">
    <div class="min-w-[40rem]" hx-get="{{ route('employer.dashboard-chart') }}" hx-trigger="load" hx-history-elt>
    </div>
</div>